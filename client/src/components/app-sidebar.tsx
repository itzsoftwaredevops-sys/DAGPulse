...
const menuItems = [
  {
    ...
    path: "/",
    description: "Live Avalanche metrics",
  },
  {
    title: "Validators",
    icon: Users,
    path: "/miners",
    description: "Address lookup, Nodes, Compare",
  },
  {
    title: "Blocks",
    icon: Blocks,
    path: "/blocks",
    description: "Explorer & validation details",
  },
  {
    title: "Forecast",
    icon: TrendingUp,
    path: "/forecast",
    description: "Staking yield predictions",
  },
  {
    title: "Analytics",
    icon: BarChart3,
  ...
  },
  {
    ...
    icon: MessageCircle,
    path: "/ai-support",
    description: "Avalanche assistant + FAQ",
  },
  {
    title: "Leaderboard",
    icon: Trophy,
    path: "/leaderboard",
    description: "Top validators & pools",
  },
  {
    title: "Guilds",
    icon: Users,
    path: "/guilds",
    description: "Validator pools & collaboration",
  },
  {
    title: "Tools",
    icon: Wrench,
